...
<div id="work" class="work-section">
	...
	<?php endif; ?>
			<div class="row">
				...
				?>
						<a href="" class="work-section-content-container col-md-4" data-toggle="modal" data-target="<?php echo '#' . strtolower( $title ) . '-modal'; ?>">	
							<div class="work-section-content-block">
								<p>
									<span class="work-section-logo <?php echo strtolower( $title ) . '-logo'; ?>"></span>
										<?php echo $content; ?>
									<span class="pseudo-cta"><?php echo $cta_text; ?></span>
								</p>
						...
						// The modal
						?>
						<div class="modal fade" id="<?php echo strtolower( $title ) . '-modal'; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $title . ' Modal'; ?>" aria-hidden="true">
							<div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<img src="<?php echo $modal_logo['url']; ?>" alt="<?php echo $modal_logo['alt']; ?>" />
									...
									<div class="container-fluid">
										<div class="row">
											...
											<div class="col-md-6 modal-overview">
												<h3><?php _e( 'Overview', 'portfolio' ); ?></h3>
											...
											<div class="col-md-6 modal-skills">
												<h3><?php _e( 'Skills', 'portfolio' ); ?></h3>
												<ul>
													<?php
													if ( have_rows( 'modal_skills_list' ) ):
														while ( have_rows( 'modal_skills_list' ) ): the_row();
													?>
								...
								<div class="modal-footer">
									<a role="button" class="cta secondary-cta" href="<?php echo $modal_secondary_cta_url; ?>" target="_blank"><?php echo $modal_secondary_cta_text; ?></a>
									<a role="button" class="cta primary-cta contact-cta" href="<?php echo $modal_primary_cta_url; ?>" data-scroll><?php echo $modal_primary_cta_text; ?></a>
								</div><!-- .modal-footer -->
