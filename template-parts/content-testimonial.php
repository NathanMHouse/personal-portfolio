				...
				while ( $query->have_posts() ) {
					...
					<div class="testimonial-content-text col-md-8 col-md-push-4">
						...
						<span class="testimonial-content-role">
							<?php echo esc_html( $testimonial_role . ', ' . $testimonial_company ); ?>
						</span>
					...
					?>
					<div class="testimonial-content-image col-md-4 col-md-pull-8" style="background-image: url( <?php echo esc_attr( $testimonial_image ); ?> );">
